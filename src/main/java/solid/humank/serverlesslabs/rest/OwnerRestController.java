...
public class OwnerRestController {
    ...
    public Collection<Owner> getOwnersList(String ownerLastName, Runnable ownersNotFound) {
	...
	public Collection<Owner> getOwners(Runnable ownersNotFound) {
        logger.info("in appropriate controller");

		Collection<Owner> owners = this.clinicService.findAllOwners();
		if(owners==null){
		    logger.info("hsqldb jpa is not work !");
		    ownersNotFound.run();
        }
		return owners;
	}
